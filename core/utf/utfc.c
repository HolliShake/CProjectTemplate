...
#define _UTFC_CC_H
    ...
    extern "C" {
        ...
        char* utf_rune_to_string(int codepoint) {
            size_t size = 
                utf_size_of_codepoint(codepoint);
        ...
        char* utf_nfkc(char* __str) {
            char* str = utf8proc_NFKC((unsigned char*) __str);
            if (str == NULL) {
        ...
        size_t utf_char_length(char* __str) {
            unsigned char c = (unsigned char) *__str;
            return utf_size_of_utf(c);
        }

        int utf_char_code_at(char* __str, size_t index) {
            char* str = __str;
        ...
        char* utf_char_at(char* __str, size_t index) {
            return utf_rune_to_string(utf_char_code_at(__str, index));
        }

        size_t utf_length(char* __str) {
            size_t length = 0;
            char* str = __str;
            while (*str) {
                str += utf_char_length(str);
